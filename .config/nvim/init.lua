...
-- Open nvim-tree on startup and reveal the file
vim.api.nvim_create_autocmd('VimEnter', {
  callback = function(data)
    ...
    -- If it's a file → cd into its directory first
...
-- Auto-quit if nvim-tree is the only window left
...
-- Quit Neovim if you manually close nvim-tree
...
local function set_custom_colors()
  ...
  hl('Statement', { fg = colors.GRADIENT1, bold = true })
  hl('Repeat', { fg = colors.PRIMARY, bold = true })
  hl('Exception', { fg = '#ffbb01' })
  hl('Function', { fg = '#00ff51' })
  hl('PreProc', { fg = '#00ffdd' })
  hl('Include', { fg = colors.PRIMARY, bold = true })
  hl('Identifier', { fg = '#edf500' })
  hl('Type', { fg = '#ff6b01' })
  hl('Constant', { fg = '#cb00f5' })
  hl('Comment', { fg = colors.ACCENT2, italic = true })
  hl('Special', { fg = colors.GRADIENT2 })
  hl('Operator', { fg = '#FF013B' })
  hl('Macro', { fg = '#0048ff' })
  hl('Underlined', { fg = '#edf500', underline = true })
  hl('Label', { fg = '#00f7ff' })
  ...
  hl('Statement', { fg = colors.GRADIENT1, bold = true })
  hl('TSFunction', { fg = '#00ff51' })
  hl('TSKeyword', { fg = colors.PRIMARY })
  hl('TSConditional', { fg = colors.PRIMARY, bold = true })
  hl('TSRepeat', { fg = colors.PRIMARY, bold = true })
  hl('TSOperator', { fg = '#FF013B' })
  hl('TSConstBuiltin', { fg = colors.GRADIENT2 })
  hl('TSVariable', { fg = '#edf500' })
  hl('TSParameter', { fg = colors.ACCENT1 })
  hl('TSInclude', { fg = colors.PRIMARY, bold = true })
  hl('TSComment', { fg = colors.ACCENT2, italic = true })
  hl('TSString', { fg = colors.PRIMARY, bold = true })
  hl('TSConstant', { fg = '#cb00f5' })
  hl('TSType', { fg = '#ff6b01' })
  hl('TSSpecial', { fg = colors.GRADIENT2 })
end
